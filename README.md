...
To make a standalone build to share, double-click **`publish.bat`** — it produces a
single self-contained `PoE2FlipOverlay.exe` that runs on any 64-bit Windows PC,
even without the .NET runtime installed.
